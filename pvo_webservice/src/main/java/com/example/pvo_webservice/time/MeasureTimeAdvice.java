package com.example.pvo_webservice.time;
...
public class MeasureTimeAdvice {
    ...
    @Around("@annotation(com.example.pvo_webservice.time.MeasureTime)")
    public Object measureTime(ProceedingJoinPoint point) throws Throwable {
        StopWatch stopWatch = new StopWatch();
        stopWatch.start();
        Object object = point.proceed();
        stopWatch.stop();
        logger.info("Time taken by " + point.getSignature().getName() + "() method is "
